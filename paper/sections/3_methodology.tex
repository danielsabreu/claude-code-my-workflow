...
\begin{equation}
    \widehat{\mathrm{Avar}}(\hat{\boldsymbol{f}}_t) = \hat{\boldsymbol{V}}^{-1}\hat{\boldsymbol{Q}}\,\hat{\boldsymbol{\Gamma}}_t\,\hat{\boldsymbol{Q}}'\hat{\boldsymbol{V}}^{-1},
    \label{eq:avar_hat}
\end{equation}
where $\hat{\boldsymbol{V}}$ and $\hat{\boldsymbol{Q}}$ replace $\boldsymbol{V}$ and $\boldsymbol{Q}$ with their sample analogues. $(1-\alpha)$ confidence bands for the $k$-th factor are then:
\begin{equation}
